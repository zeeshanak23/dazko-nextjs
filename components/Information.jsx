  ...
  return (
    <section className={styles.InformationSection}>
      ...
      <div className={styles.informationImage}>
        <img src='../dazko/homePage.webp'></img>
      </div>
      <div className={styles.SubHeading}>
        ...
        <ul>
          ...
          <li>
            <a href="#"></a>
            <span className={styles.listInformation}><ArrowRightOutlined style={{color:"#e1193e",marginRight:10}} />Men Fitness and Workout</span>
          </li>
          <li>
            <a href="#"></a>
            <span className={styles.listInformation}><ArrowRightOutlined style={{color:"#e1193e"}} />Men Fitness and Workout</span>
