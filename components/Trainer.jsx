...
import styles from "../src/styles//Trainer.module.css"
...
const Trainer = () => {
    ...
    const trainerList = [{
        imgage:"../dazko/trainer1.png",
        title:"ARON MIGHTY",
        active:isActive1,
    },
    {
        imgage:"../dazko/trainer2.png",
        title:"ALICIA BROWN",
        active:isActive2,
    },
    {
        imgage:"../dazko/trainer3.png",
        title:"ANNE HENDERSON",
        active:isActive3,
    },
    {
        imgage:"../dazko/trainer4.png",
        title:"BRUCE GRAPLER",
        active:isActive4,
    }
]
    ...
    return (
        <section className={styles.TrainerSection}>
            ...
            <div className={styles.overlapsImages}>
                <img src="../dazko/trainerBg.jpg" alt="" />
            </div>
            <div className={styles.overlapSection}>
                ...
                <div className={styles.MoboverlapSection}>
                    <div>
                    <img src="../dazko/trainer1.png" alt="" />
                    <div>
                    ...
                    <div 
                    >
                    <img src="../dazko/trainer2.png" alt="" />
                    <div>
                            <div className={styles.mobTextBox}>
                            <h3>Alicia <br /> Brown</h3>
                            <div className={styles.MobTransformdiv}>         
                    ...
                    <div>
                    <img src="../dazko/trainer3.png" alt="" />
                    <div>
                            <div className={styles.mobTextBox}>
                            <h3>Alicia <br /> Brown</h3>
                            <div className={styles.MobTransformdiv}>         
                    ...
                    <div>
                    <img src="../dazko/trainer4.png" alt="" />
                        <div>
                            <div className={styles.mobTextBox}>
                            <h3>Alicia <br /> Brown</h3>
                            <div className={styles.MobTransformdiv}>         
